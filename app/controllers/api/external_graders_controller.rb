class Api::ExternalGradersController < Api::BaseController
  ...
  def participant_qualified?(challenge, participant)
    ...
    participant_leaderboard = get_qualification(participant.id, 'Participant') || get_qualification(
        get_team_id(challenge, participant.id), 'Team')
  ...
  def get_qualification(submitter_id, submitter_type)
