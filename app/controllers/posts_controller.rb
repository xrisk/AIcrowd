class PostsController < InheritedResources::Base
  ...
  def set_my_challenges
    ...
    meta_challenges = Challenge.where(id: all_challenges.pluck(:challenge_id), meta_challenge: true, hidden_challenge: false)
    @my_challenges = all_challenges.map(&:challenge).reject!{|challenge| challenge.hidden_challenge?}.collect {|c| [ c.challenge, c.id] }
